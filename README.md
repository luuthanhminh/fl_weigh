...
- Search and Replace All `n7bluetooth` to new package id
- Search and Replace All `N7 Bluetooth` to new App display name
- Search and Replace All `com.app.n7bluetooth` to new App bundle id
